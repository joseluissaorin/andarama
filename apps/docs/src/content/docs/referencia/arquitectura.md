...
5. **Un esquema, una fuente de verdad.** `tour.json` (JSON Schema versionado en `@andarama/schema`) es el contrato entre todas las piezas.
...
4. Imágenes que exceden el cliente o subidas por API encolan un trabajo para el runner Node (`anda-tile`).
